...
import com.commusoft.diary.diarytrials.TelerikSource.CalendarTools;
import com.commusoft.diary.diarytrials.TelerikSource.RadCalendarView;
import com.commusoft.diary.diarytrials.TelerikSource.events.*;
...
/**
 * Default adapter for events displayed by {@link com.commusoft.diary.diarytrials.TelerikSource.RadCalendarView}.
 */
public class EventAdapter {

    private final RadCalendarView owner;
    private List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> events;
     ...
     */
    public EventAdapter(RadCalendarView owner, List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> events) {
        this.owner = owner;
     ...
     */
    public List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> getEventsForDate(long date) {
        if (this.events == null) {
            return null;
        }
        ...
        List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> eventsForDate = new ArrayList<com.commusoft.diary.diarytrials.TelerikSource.events.Event>();
        for (com.commusoft.diary.diarytrials.TelerikSource.events.Event event : this.events) {
            if (event == null) {
                continue;
            }
     ...
     */
    public void addEvent(com.commusoft.diary.diarytrials.TelerikSource.events.Event event) {
     ...
     */
    public List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> getEvents() {
        return events;
    }
     ...
     */
    public void setEvents(List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> events) {
        this.events = events;
        this.owner.notifyDataChanged();
    }
    ...
    private boolean eventShouldBeVisible(com.commusoft.diary.diarytrials.TelerikSource.events.Event event, long dateStart, long dateEnd) {

        if (event.isAllDay() && event.getStartDate() >= dateStart && event.getStartDate() < dateEnd) {
            return true;
        } else if (!event.isAllDay() && dateStart < event.getEndDate() && dateEnd > event.getStartDate()) {
            return true;
        }
        return false;
    }
