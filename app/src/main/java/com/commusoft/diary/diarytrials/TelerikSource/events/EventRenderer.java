...
/**
 * A default renderer class which draws the events in {@link com.commusoft.diary.diarytrials.TelerikSource.RadCalendarView}.
 */
public class EventRenderer {
    ...
    /**
     * Creates a new instance of the {@link com.commusoft.diary.diarytrials.TelerikSource.events.EventRenderer} class.
     *
    ...
    /**
     * Gets the current {@link com.commusoft.diary.diarytrials.TelerikSource.events.EventRenderMode}
    ...
    /**
     * Sets a new {@link com.commusoft.diary.diarytrials.TelerikSource.events.EventRenderMode}
    ...
    private void drawEventsInModeText(Canvas canvas, CalendarDayCell cell) {
        ...
        for (com.commusoft.diary.diarytrials.TelerikSource.events.Event event : cell.getEvents()) {
    ...
    private void drawEventsInModeShape(Canvas canvas, CalendarDayCell cell) {
        ...
        List<com.commusoft.diary.diarytrials.TelerikSource.events.Event> eventList = cell.getEvents();
        Collections.sort(eventList, new Comparator<com.commusoft.diary.diarytrials.TelerikSource.events.Event>() {
            @Override
            public int compare(com.commusoft.diary.diarytrials.TelerikSource.events.Event event, com.commusoft.diary.diarytrials.TelerikSource.events.Event event2) {
                return (event.getStartDate() < event2.getStartDate()) ? -1 : (event.getStartDate() > event2.getStartDate()) ? 1 : 0;
            }
        });

        int endOfLastShape = 0;
        for (com.commusoft.diary.diarytrials.TelerikSource.events.Event currentEvent : eventList) {
