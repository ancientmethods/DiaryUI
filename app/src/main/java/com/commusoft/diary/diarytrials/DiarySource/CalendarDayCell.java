...
public class CalendarDayCell extends CalendarCell {
    ...
    /**
     * Initializes a new instance of the {@link com.commusoft.diary.diarytrials.DiarySource.CalendarDayCell} class.
     *
    ...
    /**
     * Gets the current secondary text position. Default is TOP | RIGHT from the {@link com.commusoft.diary.diarytrials.DiarySource.CalendarTextElement} class.
     *
    ...
    /**
     * Sets the current secondary text position. Default is TOP | RIGHT from the {@link com.commusoft.diary.diarytrials.DiarySource.CalendarTextElement} class.
     *
